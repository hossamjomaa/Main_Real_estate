<%@ Page Title="" Language="C#" MasterPageFile="~/English/Main_Application/English.Master" AutoEventWireup="true" CodeBehind="Add_Asset.aspx.cs" Inherits="Main_Real_estate.English.Main_Application.Add_Asset" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <asp:Label ID="lbl_titel_Add_New_Asset" runat="server" Text="إضافة اصل جديد"></asp:Label>&nbsp;
                <asp:Label ID="lbl_Success_Add_New_Asset" runat="server" ForeColor="Green"></asp:Label>
            </h1>
        </div>
        <div class="row">
            <div class="col-lg-6">
                        ...
                        <div>
                            ...
                            <div class="form-group">
                                ...
                                <asp:RequiredFieldValidator ID="Asset_Purchase_Date_RequiredFieldValidator" ControlToValidate="txt_Asset_Purchase_Date"
                                    ...
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="Asset_Purchase_Date_Calendar" EventName="SelectionChanged" />
                                    </Triggers>
                                    </asp:UpdatePanel>
                            </div>
    ...
    <br />
    <div class="col-lg-4">
        <asp:Button ID="btn_Add_Asset" runat="server" Text="إضافة اصل" CssClass="btn  mb-1" BackColor="#52a2da" ForeColor="White" OnClick="btn_Add_Asset_Click" />
        &nbsp;&nbsp;
            <asp:Button ID="btn_Back_To_Asset_List" CssClass="btn btn-light mb-1" runat="server" Text="العودة لقائمة الأصول" ValidationGroup="x" OnClick="btn_Back_To_Asset_List_Click" />
    </div>
    <br />
