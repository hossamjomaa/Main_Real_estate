<%@ Page Title="" Language="C#" MasterPageFile="~/English/Main_Application/English.Master" AutoEventWireup="true" CodeBehind="New_Rental_Disclosure.aspx.cs" Inherits="Main_Real_estate.English.Main_Application.New_Rental_Disclosure" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="row">
            <div class="col-lg-2 mb-3">
                <h1 class="h3 mb-0 text-gray-800">
                    <asp:Label ID="lbl_titel_Rentals_List" runat="server" Text=" المؤجرات"></asp:Label>
                </h1>
            </div>
        </div>
        <div class="row">
    ...
    <%-----------------------------------------------------------------------------------------------------------%>
                        ...
                        <span runat="server" id="U_C_Span" style="margin-right:20px; font-size:30px">
                            <asp:Label ID="lbl_titelt" runat="server" Text="كشف كل المؤجرات" />
                        </span><br /><br />
                            
                               <asp:Button ID="Rental_All_Excel" runat="server" Text="Excel" OnClick="Rental_All_Excel_Click"  CssClass="btn btn-secondary right-spaced"/>
              ...
              <div runat="server" id="Unit_Contract_Div">
                      ...
                      <asp:Button ID="Rental_Unit_Excel" runat="server" Visible="false" Text="Excel" OnClick="Button1_Click" CssClass="btn btn-secondary right-spaced"/>
                                    ...
                                    <ItemTemplate>
                                        <div style="padding: 10px">
                                            ...
                                            <table class="datatable table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    <%-----------------------------------------------------------------%>
                                                    <asp:Repeater ID="Buildingg_Repeater" runat="server" ClientIDMode="Static">
                                                        <ItemTemplate>
                                                            <tr>
                                                        ...
                                                        <asp:Label ID="lbl_Building_No" runat="server" Text='<%# Eval("Building_NO") %>'></asp:Label>
                                                                    <asp:Label ID="lbl_Building_Id" runat="server" Text='<%# Eval("Half_Building_ID") %>'></asp:Label>
                                                                </th>
                                                            </tr>
                                                            <%-----------------------------------------------------------------%>
                          ...
                          <div runat="server" id="Building_Contract_Div">
                            ...
                            <asp:Button ID="Rental_Building_Excel" runat="server" Text="Excel" Visible="false" OnClick="Button2_Click" CssClass="btn btn-secondary right-spaced"/>
                    
                            <div class="col-lg-12 mb-4">
                                <asp:Repeater ID="B_Ownership_repeater" runat="server">
                                    <ItemTemplate>
                                        <div style="padding: 10px">
                                            <asp:Label ID="Label1" runat="server" Text='<%# Eval("owner_ship_Code") %>' Font-Size="20px" Font-Bold="true"></asp:Label>
                                            <table class="datatable table table-striped table-bordered">
