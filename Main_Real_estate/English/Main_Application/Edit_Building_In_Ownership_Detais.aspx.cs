...
{
    public partial class Edit_Building_In_Ownership_Detais : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                if (getBuildingDt.Rows.Count > 0)
                {
                    ...
                    Building_Condition_DropDownList.SelectedValue =
                        getBuildingDt.Rows[0]["building_condition_Building_Condition_Id"].ToString();
                    Building_Type_DropDownList.SelectedValue =
                        getBuildingDt.Rows[0]["building_type_Building_Type_Id"].ToString();
                    ownership_Name_DropDownList.SelectedValue =
                        getBuildingDt.Rows[0]["owner_ship_Owner_Ship_Id"].ToString();
                    ...
                    certificate_of_completion_Path.Text =
                        getBuildingDt.Rows[0]["certificate_of_completion_Path"].ToString();
        ...
        protected void btn_Add_Building_Click(object sender, EventArgs e)
        {
            if (Page.IsValid)
            {
                ...
                updateBuildingCmd.Parameters.AddWithValue("@owner_ship_Owner_Ship_Id",
                    ownership_Name_DropDownList.SelectedValue);
                updateBuildingCmd.Parameters.AddWithValue("@building_condition_Building_Condition_Id",
                    Building_Condition_DropDownList.SelectedValue);
                updateBuildingCmd.Parameters.AddWithValue("@building_type_Building_Type_Id",
                    Building_Type_DropDownList.SelectedValue);
        ...
        protected void btn_Back_To_Building_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command =
                new MySqlCommand(
                    "SELECT owner_ship_Owner_Ship_Id FROM building where Building_Id='" + buildingId + "'", _sqlCon);
            MySqlDataAdapter getOwnershipDa = new MySqlDataAdapter(command);
            getOwnershipDa.Fill(getOwnershipDt);
            ownershiId = getOwnershipDt.Rows[0]["owner_ship_Owner_Ship_Id"].ToString();

            Response.Redirect("Ownership_Details_Tabel.aspx?Id=" + ownershiId);
        }



        protected void Btn_Remove_Link_Image_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            ...
            Response.Redirect("Edit_Building_In_Ownership_Detais.aspx?Id=" + Building_Id);
        }

        protected void Btn_Remove_Link_Entrance_picture_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            string Building_Id = Request.QueryString["ID"];
        ...
        protected void Btn_Remove_Link_certificate_of_completion_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            string Building_Id = Request.QueryString["ID"];
        ...
        protected void Btn_Remove_Link_Permit_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            string Building_Id = Request.QueryString["ID"];
        ...
        protected void Btn_Remove_Link_Maps_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            string Building_Id = Request.QueryString["ID"];
        ...
        protected void Btn_Remove_Link_Statement_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            string Building_Id = Request.QueryString["ID"];
        ...
        protected void Btn_Remove_Link_Plan_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            string Building_Id = Request.QueryString["ID"];
        ...
        protected void Btn_Remove_Link_Building_Photo_Click(object sender, System.Web.UI.ImageClickEventArgs e)
        {
            string Building_Id = Request.QueryString["ID"];
        ...
        protected void Delete_Building_Click(object sender, EventArgs e)
        {
            ...
            _sqlCon.Open();
            DataTable getBuildingIdDt = new DataTable();
            MySqlCommand getBuildingIdCmd = new MySqlCommand("SELECT building_Building_Id FROM units WHERE building_Building_Id = @ID And Delete_Active != '1'", _sqlCon);
            MySqlDataAdapter getBuildingIdDa = new MySqlDataAdapter(getBuildingIdCmd);
            getBuildingIdCmd.Parameters.AddWithValue("@ID", BuildingId);
            getBuildingIdDa.Fill(getBuildingIdDt);
            if (getBuildingIdDt.Rows.Count == 0)
            {
                string updateBuildingQuery = "UPDATE building SET Delete_Active=@Delete_Active WHERE Building_Id=@ID";
                MySqlCommand updateBuildingCmd = new MySqlCommand(updateBuildingQuery, _sqlCon);
                updateBuildingCmd.Parameters.AddWithValue("@ID", BuildingId);
                updateBuildingCmd.Parameters.AddWithValue("@Delete_Active", "1");
                updateBuildingCmd.ExecuteNonQuery();
