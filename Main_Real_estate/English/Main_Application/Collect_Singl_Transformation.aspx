<%@ Page Title="" Language="C#" MasterPageFile="~/English/Main_Application/English.Master" AutoEventWireup="true" CodeBehind="Collect_Singl_Transformation.aspx.cs" Inherits="Main_Real_estate.English.Main_Application.Collect_Singl_Transformation" %>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <asp:Label ID="lbl_Transformation_Date" runat="server" Text="تاريخ الحوالة"></asp:Label>
                                    <asp:TextBox ID="txt_Transformation_Date" Enabled="false" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>

                             <div class="col-lg-6">
                                <div class="form-group">
                                    <asp:Label ID="lbl_transformation_Amount" runat="server" Text="قيمة الحوالة"></asp:Label>
                                    <asp:TextBox ID="txt_transformation_Amount" Enabled="false" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <asp:Label ID="lbl_Acount_No" runat="server" Text="رقم الحساب"></asp:Label>
                                    <asp:TextBox ID="txt_Acount_No" Enabled="false" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <asp:Label ID="lbl_Soft_Cde" runat="server" Text="سوفت كود"></asp:Label>
                                    <asp:TextBox ID="ltxt_Soft_Cde" Enabled="false" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                        </div>
