<%@ Page Title="" Language="C#" MasterPageFile="~/English/Main_Application/English.Master" AutoEventWireup="true" CodeBehind="Tenant_Disclosure.aspx.cs" Inherits="Main_Real_estate.English.Main_Application.Tenant_Disclosure" %>
        ...
        <div class="row">
            <div class="col-lg-2 mb-3">
                <h1 class="h3 mb-0 text-gray-800">
                    <asp:Label ID="lbl_titel_Tenants_List" runat="server" Text="المستأجرين"></asp:Label>
                </h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 mb-4">
                ...
                <div class="card">
                    ...
                    <div  id="Grid" >
                        ...
                        <asp:Button ID="Button3" runat="server" Text="Excel"  OnClick="Button3_Click"   CssClass="btn btn-secondary right-spaced"/><br />

                        
                     
                        <%--------------------------------------------------------------------------------------------------------------------%>
                            <div runat="server" id="Unit_Contract_Div">
                                <asp:Button ID="Button1" runat="server" Text="Excel" Visible="false"  OnClick="Button1_Click" CssClass="btn btn-secondary right-spaced"/><br />
                                <br />
                                <div class="row" style="">
                                    <div class="col-lg-12 mb-4">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <asp:Repeater ID="Body_Repeater" runat="server" ClientIDMode="Static">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <tr>
                                                                            <td>
                                                                                <asp:Label ID="lbl_owner_ship_Code" runat="server" Text='<%# Eval("owner_ship_Code") %>'></asp:Label></td>
                                                                            <td>
                                                                                <asp:Label ID="lbl_Owner_Ship_AR_Name" runat="server" Text='<%# Eval("Owner_Ship_AR_Name") %>'></asp:Label></td>
                                                                            <td>
                                                                                <asp:Label ID="lbl_Building_Arabic_Name" runat="server" Text='<%# Eval("Building_Arabic_Name") %>'></asp:Label></td>
                                                                            <td>
                                                                                <asp:Label ID="lbl_Building_NO" runat="server" Text='<%# Eval("Building_NO") %>'></asp:Label></td>
                                                                            <td>
                    ...
                    <%--*********************************************************************** كشف مستأجرين العقود الكجملة **************************************************************--%>
                            <div runat="server" id="Building_Contract_Div">
                                <asp:Button ID="Button2" runat="server" Text="Excel" Visible="false" OnClick="Button2_Click" CssClass="btn btn-secondary right-spaced"/><br />
                                <br />
                                <div class="row" style="">
                                    <div class="col-lg-12 mb-4">
