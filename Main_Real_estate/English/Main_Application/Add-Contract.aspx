<%@ Page Title="" Language="C#" MasterPageFile="~/English/Main_Application/English.Master" AutoEventWireup="true" CodeBehind="Add-Contract.aspx.cs" Inherits="Main_Real_estate.English.Main_Application.Add_Contract1" %>
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">
        <asp:Label ID="lbl_titel_Add_New_Tenant" runat="server" Text="إبرام عقد جديد"></asp:Label>
        <asp:Label ID="Contract_id" runat="server"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Label ID="lbl_Success_Add_New_Contract" runat="server" ForeColor="#66bb6a"></asp:Label>
    </h1>
</div>
<!----------------------------------------------------------------------------------------------------------->
<div class="row">
...
<div class="row">
    <div class="col-lg-2">
        ...
        <div class="form-group" style="border-style: solid; width:180px; border-radius: 7px; border-width: 1px; background-color: #f3f3f3; padding: 5px;">
            <asp:Label ID="txt_Dtl_Employee_Name" runat="server" Font-Size="20px"></asp:Label>
        </div>
    </div>
    <div class="col-lg-3" style="max-width: 20%;">
        <div class="form-group">
            ...
            <br />
            <asp:DropDownList ID="Contract_Templet_DropDownList" runat="server"  CssClass="form-control" Width="220px" Font-Size="15px" AutoPostBack="true" OnSelectedIndexChanged="Contract_Templet_DropDownList_SelectedIndexChanged">
            </asp:DropDownList>
            <asp:RequiredFieldValidator ID="Tenant_Type_RequiredFieldValidator" ValidationGroup="Contract_RequiredField" ControlToValidate="Contract_Templet_DropDownList"
                                        InitialValue="إختر نموذج العقد ...." runat="server" ErrorMessage="* حقل مطلوب !!!" ForeColor="#fc544b">
    ...
    <div class="col-lg-2" >
        <div class="form-group">
            ...
            <br />
            <asp:DropDownList ID="Tenan_Name_DropDownList" runat="server" Width="220px" Font-Size="15px" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="Tenan_Name_DropDownList_SelectedIndexChanged">
            </asp:DropDownList>
        <asp:ImageButton ID="Add_Tenant" runat="server" ImageUrl="Main_Image/plus.png" OnClick="Add_Tenant_Click" Width="15px" Height=15px/>

            <asp:RequiredFieldValidator ID="Tenan_Name_RequiredFieldValidator" ControlToValidate="Tenan_Name_DropDownList"
                                        InitialValue="إختر اسم المستأجر ...." runat="server" ValidationGroup="Contract_RequiredField" ErrorMessage="* حقل مطلوب !!!" ForeColor="#fc544b">
            </asp:RequiredFieldValidator>

        </div>
    </div>

    <div class="col-lg" id="Com_Rep_Div" runat="server" visible="false" style="max-width: 20%;">
        <div class="form-group">
            <asp:Label ID="lbl_Com_Rep" runat="server" Text="اسم الممثل عن الشركة"></asp:Label>
            <asp:DropDownList ID="Com_Rep_DropDownList" runat="server" CssClass="form-control" Width="220px" Font-Size="15px">
            </asp:DropDownList>
            <asp:RequiredFieldValidator ID="Com_Rep_RequiredFieldValidator" ControlToValidate="Com_Rep_DropDownList"
                                        InitialValue="إختر اسم الممثل ...." runat="server" ValidationGroup="Contract_RequiredField" ErrorMessage="* حقل مطلوب !!!" ForeColor="#fc544b">
            </asp:RequiredFieldValidator>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-lg" id="Unit_Div" runat="server">
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="Tenan_Name_DropDownList"
                                        InitialValue="إختر الوحدة ...." runat="server" ValidationGroup="Contract_RequiredField" ErrorMessage="* حقل مطلوب !!!" ForeColor="#fc544b">
            </asp:RequiredFieldValidator>
        </div>
    </div>
</div>
    ...
    <div class="row">
            <div class="col-lg-12">
                <div class="container-fluid" style="border-style:solid;border-color:#efefef">
                    <asp:Label ID="XXXX" runat="server" Text="XXXXXX" Visible="false"></asp:Label>
                <!-- Simple Tables -->
    ...
    <div class="col-lg">
        <div id="div_Reason_For_Rent" runat="server">
            <div class="form-group">
                ...
                <asp:Label ID="lblCheckItems" runat="server" Visible="false"></asp:Label>
                ...
                <asp:RequiredFieldValidator ID="Reason_For_Rent_RequiredFieldValidator" ValidationGroup="Contract_RequiredField" ControlToValidate="Reason_For_Rent_DropDownList"
                                            InitialValue="إختر الغرض من الإيجار ...." runat="server" ErrorMessage="* حقل مطلوب !!!" ForeColor="#fc544b">
                </asp:RequiredFieldValidator>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg">
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ID="Contract_Type_RequiredFieldValidator" ValidationGroup="Contract_RequiredField" ControlToValidate="Contract_Type_DropDownList"
                                        InitialValue="إختر الوحدة الزمنية ...." runat="server" ErrorMessage="* حقل مطلوب !!!" ForeColor="#fc544b">
            </asp:RequiredFieldValidator>
        </div>
    </div>
    <div class="col-lg">
        <div id="div_No_Of_Months" runat="server" visible="false">
            <div class="form-group">
                ...
                <asp:TextBox ID="txt_No_Of_Months_Or_Years" runat="server" TextMode="Number" min="1" max="11" step="1" CssClass="form-control" AutoPostBack="true" OnTextChanged="txt_No_Of_Months_Or_Years_TextChanged"></asp:TextBox>
                <asp:RequiredFieldValidator ID="No_Of_Months_RequiredFieldValidator" ValidationGroup="Contract_RequiredField" ControlToValidate="Contract_Type_DropDownList"
                                            InitialValue="إختر عدد الأشهر ...." runat="server" ErrorMessage="* حقل مطلوب !!!" ForeColor="#fc544b">
                </asp:RequiredFieldValidator>
            </div>
        </div>
    </div>
        ...
        <div class="form-group">
            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                <ContentTemplate>
                    ...
                    ErrorMessage="dd/MM/yyyy" ValidationGroup="Contract_RequiredField"  ForeColor="#fc544b"/>
                    ...
                    <div id="Sign_Date_divCalendar" runat="server" style="position: page;" visible="false">
                        ...
                        <asp:Calendar ID="Sign_Date_Calendar" runat="server" Height="200px" Width="220px" BackColor="#f0f0f3" BorderColor="#ccc" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="10pt" ForeColor="#5a5c69" OnSelectionChanged="Sign_Date_Calendar_SelectionChanged1">
    ...
    <div class="col-lg-3">
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ID="Payment_Type_RequiredFieldValidator" ValidationGroup="Contract_RequiredField" ControlToValidate="Payment_Type_DropDownList"
                                        InitialValue="إختر نوع الدفعات ...." runat="server" ErrorMessage="* حقل مطلوب !!!" ForeColor="#fc544b">
            </asp:RequiredFieldValidator>
        </div>
...
<div class="row">
    <%--<div class="col-lg-3">
        <div class="form-group">
            ...
            <asp:RequiredFieldValidator ID="Payment_Frquancy_RequiredFieldValidator" ValidationGroup="Contract_RequiredField" ControlToValidate="Payment_Frquancy_DropDownList"
                                        InitialValue="إختر تكرار الدفعات ...." runat="server" ErrorMessage="* حقل مطلوب !!!" ForeColor="#fc544b">
            </asp:RequiredFieldValidator>
        </div>
    </div>--%>
    ...
    <div class="col-lg-3">
        ...
        <asp:RequiredFieldValidator ID="Rental_allowed_Or_Not_allowed_RequiredFieldValidator" ValidationGroup="Contract_RequiredField"
                                    ControlToValidate="Rental_allowed_Or_Not_allowed_RadioButtonList" runat="server" ErrorMessage="* حقل مطلوب !!!" ForeColor="#fc544b">
        </asp:RequiredFieldValidator>
    </div>
            ...
            <div class="col-lg-12" id="Contract_Details_Div" runat="server" visible="false">
                <div class="form-group">
                    ...
                    <asp:RegularExpressionValidator ID="Contract_Details_RegularExpressionValidator" runat="server" ControlToValidate="txt_Contract_Details"
                                                    EnableClientScript="True" ErrorMessage="!!! يُسمح فقط بالأحرف العربية" ForeColor="#fc544b"
...
<%--------------------------------------------------------------Cheque / transformation / Cash Gridviwes ------------------------------------------------------------------------------------------------------%>
    ...
    <div class="col-lg-3">
        ...
        ControlToValidate="Paymen_Method_RadioButtonList" runat="server" ErrorMessage="* حقل مطلوب !!!" ForeColor="#fc544b">
        </asp:RequiredFieldValidator>
    </div>
...
<div id="container" class="container-fluid" style="border-style: solid; border-radius: 10px;">
    ...
    <div calss="row">
        <h4>
            <asp:Label ID="lbl_Cheque" runat="server"></asp:Label>
        </h4>
        <div class="row">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <div id="transformation_Date_Div" runat="server" style="position: page;" visible="false">
                                ...
                                <asp:Calendar ID="transformation_Date_Calendar" runat="server" Height="200px" Width="220px" BackColor="#f0f0f3" BorderColor="#ccc" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="10pt" ForeColor="#5a5c69" OnSelectionChanged="transformation_Date_Calendar_SelectionChanged">
                                    <DayHeaderStyle BackColor="#52a2da" ForeColor="#ffffff" Height="1px" />
                                    <NextPrevStyle Font-Size="8pt" ForeColor="#ffffff" />
                                    <OtherMonthDayStyle ForeColor="#5a5c69" />
                                    <SelectedDayStyle BackColor="#ff8d4f" Font-Bold="True" ForeColor="#ffffff" />
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            ...
                            <div id="Cash_Date_Div" runat="server" style="position: page;" visible="false">
                                ...
                                <asp:Calendar ID="Cash_Date_Calendar" runat="server" Height="200px" Width="220px" BackColor="#f0f0f3" BorderColor="#ccc" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="10pt" ForeColor="#5a5c69" OnSelectionChanged="Cash_Date_Calendar_SelectionChanged">
                                    <DayHeaderStyle BackColor="#52a2da" ForeColor="#ffffff" Height="1px" />
                                    <NextPrevStyle Font-Size="8pt" ForeColor="#ffffff" />
                                    <OtherMonthDayStyle ForeColor="#5a5c69" />
                                    <SelectedDayStyle BackColor="#ff8d4f" Font-Bold="True" ForeColor="#ffffff" />
        ...
        <div class="row" style="overflow-x: auto;" runat="server" id="Cheque_Div">
            ...
            &nbsp;&nbsp;
            <asp:Label ID="lbl_Worrnig_Cheque" Text="معلومات الشيك غير كاملة ( اسم المستأجر  /  نوع الشيك  /  اسم البنك)" runat="server" ForeColor="#fc544b" Visible="false"></asp:Label>
            <div class="col-lg-12">
                <div class="form-group">
                                ...
                                <asp:UpdatePanel ID="Cheque_Date_UpdatePanel" runat="server">
                                    <ContentTemplate>
                                        ...
                                        <div id="Cheque_Date_Div" runat="server" visible="false" style="position: page;">
                                            <asp:Calendar ID="Cheque_Date_Calendar" runat="server" Height="200px" Width="220px" BackColor="#f0f0f3" BorderColor="#ccc" BorderWidth="1px" CellPadding="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="10pt" ForeColor="#5a5c69" OnSelectionChanged="Cheque_Date_Calendar_SelectionChanged">
                                                <DayHeaderStyle BackColor="#52a2da" ForeColor="#ffffff" Height="1px" />
                                                <NextPrevStyle Font-Size="8pt" ForeColor="#ffffff" />
                                                <OtherMonthDayStyle ForeColor="#5a5c69" />
                                                <SelectedDayStyle BackColor="#ff8d4f" Font-Bold="True" ForeColor="#ffffff" />
...
<br/>
<%-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------%>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="btn_Add_Contract" runat="server" Text="إبرام عقد" CssClass="btn  mb-1" BackColor="#52a2da" ForeColor="White" Width="248px" ValidationGroup="Contract_RequiredField" OnClick="btn_Add_Contract_Click"/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
