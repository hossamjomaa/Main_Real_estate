<%@ Page Title="" Language="C#" MasterPageFile="~/English/Master_Panal/Admin_Panel.Master" AutoEventWireup="true" CodeBehind="Edit_Role.aspx.cs" Inherits="Main_Real_estate.English.Master_Panal.Edit_Role" %>
    ...
    <div class="container-fluid" id="container-wrapper">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <asp:Label ID="lbl_titel_Edit_Role" runat="server" Text="تعديل الصلاحية :"></asp:Label>
                &nbsp;
                <asp:Label ID="lbl_titel_Role_Name" runat="server" ></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <asp:Label ID="lbl_Success_Edit_Role" runat="server" ForeColor="#00FF40"></asp:Label>
            </h1>
        </div>
        <!----------------------------------------------------------------------------------------------------------->
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-3">
                <asp:Button ID="btn_Edit_Role" runat="server" Text="حفظ التغيرات " CssClass="btn btn" BackColor="#52a2da" ValidationGroup="Role_RequiredField" ForeColor="White" Width="248px" OnClick="btn_Edit_Role_Click" />
            </div>
            <div class="col-lg-3">
