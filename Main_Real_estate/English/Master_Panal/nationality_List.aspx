<%@ Page Title="" Language="C#" MasterPageFile="~/English/Master_Panal/Admin_Panel.Master" AutoEventWireup="true" CodeBehind="nationality_List.aspx.cs" Inherits="Main_Real_estate.English.Master_Panal.Nationality_List" %>
                    ...
                    <div class="table-responsive" style="border-radius: 10px;" id="Grid">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td> <asp:Label ID="lbl_English_nationality" runat="server" Text='<%# Eval("English_nationality") %>' /></td>
                                <td>
                                    <asp:LinkButton  runat="server" CommandArgument='<%# Eval("nationality_ID") %>' OnClientClick="return confirm('هل أنت متأكد أنك تريد حذف؟');" OnClick="Delete" ><i class="fa fa-trash" style="font-size:18px;"></i></asp:LinkButton>
                                    <asp:LinkButton  runat="server" CommandArgument='<%# Eval("nationality_ID") %>' OnClick="Edit"> <i class="fa fa-pencil" style="font-size:18px;"></i> </asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
