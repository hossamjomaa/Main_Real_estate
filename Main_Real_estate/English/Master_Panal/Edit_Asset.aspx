<%@ Page Title="" Language="C#" MasterPageFile="~/English/Master_Panal/Admin_Panel.Master" AutoEventWireup="true" CodeBehind="Edit_Asset.aspx.cs" Inherits="Main_Real_estate.English.Master_Panal.Edit_Asset" %>
    ...
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                ...
                &nbsp;&nbsp;&nbsp;
                <asp:Label ID="Aseet_Serial_Number" runat="server" ></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="lbl_Success_Edit_Asset" runat="server" ForeColor="#00FF40"></asp:Label>
            </h1>
        </div>
        <!----------------------------------------------------------------------------------------------------------->
        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="Asset_SubType_DropDownList" runat="server" CssClass="form-control" >
                                    </asp:DropDownList>
                                    ...
                                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                        <ContentTemplate>
                                            ...
                                            <div id="purchase_Date_divCalendar" runat="server" style="position: page;" visible="false">
                                                <asp:Calendar ID="purchase_Date_Calendar" runat="server" Height="200px" Width="220px" BackColor="White" BorderColor="#3366CC" BorderWidth="1px" CellPEditing="1" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="#003399" OnSelectionChanged="purchase_Date_Calendar_SelectionChanged1">
                    ...
                    <div class="row" style="border-style: solid" id="Waranty_Div" runat="server" visible="false">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <asp:Label ID="Waranty_Image_FileName" runat="server" Visible="false"></asp:Label>
                                <asp:Label ID="Waranty_Image_Path" runat="server" Visible="false"></asp:Label>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
        <asp:Button ID="btn_Edit_Asset" runat="server" Text="حفظ التغيرات" CssClass="btn btn" ValidationGroup="Asst_RequiredField"  BackColor="#52a2da" ForeColor="White" Width="248px" OnClick="btn_Edit_Asset_Click"    />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
