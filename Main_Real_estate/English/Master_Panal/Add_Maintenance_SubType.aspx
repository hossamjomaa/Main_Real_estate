<%@ Page Title="" Language="C#" MasterPageFile="~/English/Master_Panal/Admin_Panel.Master" AutoEventWireup="true" CodeBehind="Add_Maintenance_SubType.aspx.cs" Inherits="Main_Real_estate.English.Master_Panal.Add_Maintenance_SubType" %>
    ...
    <div class="container-fluid" id="container-wrapper" style="margin: auto;">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <asp:Label ID="lbl_titel_Add_New_Maintenance_Subtypes" runat="server" Text="إضافة نوع صيانة فرعي"></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="lbl_Success_Add_New_Maintenance_Subtypes" runat="server" ForeColor="#00FF40"></asp:Label></h1>
        </div>
        <!----------------------------------------------------------------------------------------------------------->
        <div class="row">
            <div class="col-lg-10">
                <div class="card mb-10">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txt_En_Maintenance_Subtypes_Name"
                        ...
                        <div class="form-group">
                            ...
                            &nbsp;<asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txt_Ar_Maintenance_Subtypes_Name"
        ...
        <br />
        <asp:Button ID="btn_Add_Maintenance_Subtypes" runat="server" Text="إضافة نوع صيانة جديد" CssClass="btn btn" BackColor="#52a2da" ForeColor="White" Width="248px" OnClick="btn_Add_Maintenance_Subtypes_Click" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btn_Back_To_Maintenance_Subtypes_List" runat="server" Text="العودة لقائمة أنوع الصيانة" ValidationGroup="x" CssClass="btn btn-light mb-1" OnClick="btn_Back_To_Maintenance_Subtypes_List_Click" />
    </div>
