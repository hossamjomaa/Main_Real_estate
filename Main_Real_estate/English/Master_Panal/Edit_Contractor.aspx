<%@ Page Title="" Language="C#" MasterPageFile="~/English/Master_Panal/Admin_Panel.Master" AutoEventWireup="true" CodeBehind="Edit_Contractor.aspx.cs" Inherits="Main_Real_estate.English.Master_Panal.Edit_Contractor" %>
            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <asp:Button ID="btn_Edit_contractor" runat="server" Text="إضافة مقاول" CssClass="btn btn" BackColor="#52a2da" ForeColor="White"   Width="248px" OnClick="btn_Edit_contractor_Click"  />
                            </div>
                            <div class="col-lg-3">
