<%@ Page Title="" Language="C#" MasterPageFile="~/English/Master_Panal/Admin_Panel.Master" AutoEventWireup="true" CodeBehind="Edit_Company_Rep.aspx.cs" Inherits="Main_Real_estate.English.Master_Panal.Edit_Company_Rep" %>
    ...
    <div class="container-fluid" id="container-wrapper" style="margin: auto;">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="lbl_Success_Edit_Com_rep" runat="server" ForeColor="#00FF40"></asp:Label></h1>
        </div>
        <!----------------------------------------------------------------------------------------------------------->
        <div class="row">
            <div class="col-lg-12">
                <div class="card mb-10">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <asp:Label ID="lbl_Com_Rep_Qid_File" runat="server" Text="تعديل صورة البطاقة الشخصية"></asp:Label>
                                    <asp:FileUpload ID="Com_Rep_Qid_File_FileUpload" runat="server" CssClass="form-control" />
                                    <asp:Label ID="Qid_Path" runat="server" Visible="false"></asp:Label>
                                    <asp:Label ID="Qid_File_Name" runat="server" Visible="false"></asp:Label>
                                </div>
                            </div>
        ...
        <br />
        <asp:Button ID="btn_ُEdit_Com_rep" runat="server" Text="حفظ التغيرات" CssClass="btn btn" BackColor="#52a2da" ForeColor="White" Width="248px" OnClick="btn_ُEdit_Com_rep_Click" />
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
