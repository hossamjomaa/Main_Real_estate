<%@ Page Title="" Language="C#" MasterPageFile="~/English/Master_Panal/Admin_Panel.Master" AutoEventWireup="true" CodeBehind="Edit_transformation_Bank.aspx.cs" Inherits="Main_Real_estate.English.Master_Panal.Edit_transformation_Bank" %>
    ...
    <div class="container-fluid" id="container-wrapper" style="margin: auto;">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <asp:Label ID="lbl_titel_Edit_New_Bank" runat="server" Text="تعديل معلومات البنك"></asp:Label>
                <asp:Label ID="lbl_Bank_Name" runat="server" ></asp:Label>
            </h1>
        </div>
        <!----------------------------------------------------------------------------------------------------------->
        <div class="row">
            <div class="col-lg-12">
                <div class="card mb-10">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                               <asp:Button ID="btn_Edit_Bank" runat="server" Text="تحديث " CssClass="btn btn" BackColor="#52a2da" ForeColor="White" Width="248px"  OnClick="btn_Edit_Bank_Click"  />
                            </div>
                            <div class="col-lg-6">
