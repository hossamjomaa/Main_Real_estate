...
namespace Main_Real_estate.English.Master_Panal
{
    public partial class Department_List : System.Web.UI.Page
    {
        ...
        {
            try { Helper.GetDataReader("SELECT * FROM department", _sqlCon, The_Table); }
        ...
        protected void Delete(object sender, EventArgs e)
        {
            try
            {
                ...
                _sqlCon.Open();
                string quary1 = "DELETE FROM department WHERE Department_Id=@ID  ";
        ...
        {
            string id = (sender as LinkButton).CommandArgument;
            Response.Redirect("Edit_Department.aspx?Id=" + id);
        }
