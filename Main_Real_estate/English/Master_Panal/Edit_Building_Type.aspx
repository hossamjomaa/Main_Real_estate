<%@ Page Title="" Language="C#" MasterPageFile="~/English/Master_Panal/Admin_Panel.Master" AutoEventWireup="true" CodeBehind="Edit_Building_Type.aspx.cs" Inherits="Main_Real_estate.English.Master_Panal.Edit_Building_Type" %>
    ...
    <div class="container-fluid" id="container-wrapper" style="margin:auto; ">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <asp:Label ID="lbl_titel_Edit_New_Building_Type" runat="server" Text="تعديل نوع البناء : "></asp:Label>
                <asp:Label ID="lbl_Name_Of_Building_Type" runat="server" Text=""></asp:Label>&nbsp;
                <asp:Label ID="lbl_Success_Edit_New_Building_Type" runat="server" ForeColor="#00FF40"></asp:Label></h1>
        </div>
        <!----------------------------------------------------------------------------------------------------------->
        <div class="row">
            <div class="col-lg-10">
        ...
        <br />
        <asp:Button ID="btn_Edit_Building_Type" runat="server" Text="حفظ التغيرات" CssClass="btn btn" BackColor="#52a2da" ForeColor="White" Width="248px" OnClick="btn_Edit_Building_Type_Click"    />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btn_Back_To_Building_Type_List" runat="server" Text="العودة لقائمة أنواع الأبنية" CssClass="btn btn-light mb-1" OnClick="btn_Back_To_Building_Type_List_Click"/>
    </div>
</asp:Content>
