<%@ Page Title="" Language="C#" MasterPageFile="~/English/Master_Panal/Admin_Panel.Master" AutoEventWireup="true" CodeBehind="Edit_Sub_Type_Evaluation.aspx.cs" Inherits="Main_Real_estate.English.Master_Panal.Edit_Sub_Type_Evaluation" %>
     ...
     <div class="container-fluid" id="container-wrapper" style="margin:auto; ">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <asp:Label ID="lbl_titel_Edit_New_Sub_Type_Evaluation" runat="server" Text="إضافة نوع فرعي جديد"></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="lbl_Success_Edit_New_Sub_Type_Evaluation" runat="server" ForeColor="#00FF40"></asp:Label></h1>
        </div>
        <!----------------------------------------------------------------------------------------------------------->
        <div class="row">
            <div class="col-lg-10">
                         ...
                         <div class="form-group">
                              ...
                              <div class="form-group">
                               <asp:Label ID="lbl_Sub_Type_Evaluation_Number" runat="server"  Text=" الوزن"></asp:Label>&nbsp;
                                ...
                                <asp:TextBox ID="txt_Sub_Type_Evaluation_Number" runat="server" TextMode="Number" min="1" max="100" CssClass="form-control"
        ...
        <br />
        <asp:Button ID="btn_Edit_Sub_Type_Evaluation" runat="server" Text="إضافة " CssClass="btn btn" BackColor="#52a2da" ForeColor="White" Width="248px" OnClick="btn_Edit_Sub_Type_Evaluation_Click"    />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
