<%@ Page Title="" Language="C#" MasterPageFile="~/English/Master_Panal/Admin_Panel.Master" AutoEventWireup="true" CodeBehind="Sub_Type_Evaluation_List.aspx.cs" Inherits="Main_Real_estate.English.Master_Panal.Sub_Type_Evaluation_List" %>
        ...
        <div class="row">
            <div class="col-lg-4 mb-3" style="">
                <h1 class="h3 mb-0 text-gray-800">
                    <asp:Label ID="lbl_titel" runat="server" Text="قائمة الأنواع الفرعية لتقيم العملاء"></asp:Label>
                </h1>
            </div>
            <div class="col-lg-4">
                    ...
                    <div class="table-responsive" style="border-radius: 10px;" id="Grid">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:LinkButton  runat="server" CommandArgument='<%# Eval("Sub_Type_Evaluation_Id") %>' OnClientClick="return confirm('هل أنت متأكد أنك تريد حذف؟');" OnClick="Delete" ><i class="fa fa-trash" style="font-size:18px;"></i></asp:LinkButton>
                                    <asp:LinkButton  runat="server" CommandArgument='<%# Eval("Sub_Type_Evaluation_Id") %>' OnClick="Edit"> <i class="fa fa-pencil" style="font-size:18px;"></i> </asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                        <FooterTemplate>
