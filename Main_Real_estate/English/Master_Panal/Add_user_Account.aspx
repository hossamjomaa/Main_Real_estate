<%@ Page Title="" Language="C#" MasterPageFile="~/English/Master_Panal/Admin_Panel.Master" AutoEventWireup="true" CodeBehind="Add_user_Account.aspx.cs" Inherits="Main_Real_estate.English.Master_Panal.Add_user_Account" %>
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <asp:Label ID="lbl_titel_Add_user_Account" runat="server" Text="إضافة حساب مستخدم جديد"></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="lbl_Success_Add_user_Account" runat="server" ForeColor="#00FF40"></asp:Label></h1>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-1">
                        <asp:Button ID="btn_Add_user_Account" runat="server" Text="تأكيد" ValidationGroup="user_Account" CssClass="btn  mb-1" BackColor="#52a2da" ForeColor="White" OnClick="btn_Add_user_Account_Click" />
                    </div>
                    <div class="col-lg-3">
