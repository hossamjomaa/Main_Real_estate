<%@ Page Title="" Language="C#" MasterPageFile="~/English/Master_Panal/Admin_Panel.Master" AutoEventWireup="true" CodeBehind="Add_Asset_Location.aspx.cs" Inherits="Main_Real_estate.English.Master_Panal.Add_Asset_Location" %>
     ...
     <div class="container-fluid" id="container-wrapper" style="margin:auto; ">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <asp:Label ID="lbl_titel_Add_New_Asset_location" runat="server" Text="إضافة مكان اصل جديد"></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="lbl_Success_Add_New_Asset_location" runat="server" ForeColor="#00FF40"></asp:Label></h1>
        </div>
        <!----------------------------------------------------------------------------------------------------------->
        <div class="row">
            <div class="col-lg-10">
        ...
        <br />
        <asp:Button ID="btn_Add_Asset_location" runat="server" Text="إضافة مكان أصل" CssClass="btn btn" BackColor="#52a2da" ForeColor="White" Width="248px" OnClick="btn_Add_Asset_location_Click"   />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btn_Back_To_Asset_location_List" runat="server" Text="العودة لقائمة أماكن الأصول" ValidationGroup="x" CssClass="btn btn-light mb-1" OnClick="btn_Back_To_Asset_List_Click"/>
    </div>
</asp:Content>
