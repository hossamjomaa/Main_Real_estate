<%@ Page Title="" Language="C#" MasterPageFile="~/English/Master_Panal/Admin_Panel.Master" AutoEventWireup="true" CodeBehind="Edit_Employee.aspx.cs" Inherits="Main_Real_estate.English.Master_Panal.Edit_Employee" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!----------------------------------------------------------------------------------------------------------->
     <div class="d-sm-flex align-items-center justify-content-between mb-4">
       ...
       <asp:Label ID="lbl_titel_Edit_New_Employee" runat="server" Text="Edit Employee"></asp:Label>
           <asp:Label ID="lbl_titel_Name_Edit_Employee" runat="server"></asp:Label>&nbsp;
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <asp:Label ID="lbl_Success_Edit_Employee" runat="server" ForeColor="#00FF40"></asp:Label>
       </h1>
     </div>
    <!----------------------------------------------------------------------------------------------------------->
        <div class="row">
                 ...
                 <div class="card-body">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                            <div class="row">
                                <div class="col-lg-6">
                                    <asp:Label ID="lbl_Employee_Photo" runat="server" Text="تعديل صورة الموظف"></asp:Label>
                                    &nbsp;
                                    <asp:Label ID="lbl_path" runat="server" Text="Label" Visible="False"></asp:Label>
                                     <asp:Label ID="Photo_Name" runat="server" Text="Label" Visible="False"></asp:Label>
                                    <asp:FileUpload ID="FUL_Employee_Photo" runat="server" CssClass="form-control" />
                                </div>

                                <div class="col-lg-6">
                                    <asp:Panel ID="Panel1" runat="server">
                                        <asp:Image ID="Employee_Photo" runat="server" Width="50%" Height="70%" />
                                    </asp:Panel>
                                </div>
                            </div>
                        </div>
        ...
        <asp:Button ID="btn_Edit_Employee" runat="server" Text="حفظ التغيرات" CssClass="btn btn" BackColor="#52a2da" ForeColor="White"   Width="248px" OnClick="btn_Edit_Employee_Click1" />
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
