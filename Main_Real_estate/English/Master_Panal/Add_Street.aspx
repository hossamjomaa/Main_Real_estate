<%@ Page Title="" Language="C#" MasterPageFile="~/English/Master_Panal/Admin_Panel.Master" AutoEventWireup="true" CodeBehind="Add_Street.aspx.cs" Inherits="Main_Real_estate.English.Master_Panal.Add_Street" %>
    ...
    <div class="container-fluid" id="container-wrapper" style="margin:auto; ">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <asp:Label ID="lbl_titel_Add_New_Street" runat="server" Text="Add New Street"></asp:Label>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Label ID="lbl_Success_Add_New_Street" runat="server" ForeColor="#00FF40"></asp:Label></h1>
        </div>
        <!----------------------------------------------------------------------------------------------------------->
        <div class="row">
            <div class="col-lg-10">
        ...
        <br />
        <asp:Button ID="btn_Add_Street" runat="server" Text="Add Street" CssClass="btn btn-danger mb-1" Width="248px" OnClick="Button1_Click"   />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btn_Back_To_Street_List" runat="server" Text="Back To Street List" ValidationGroup="x" CssClass="btn btn-light mb-1" OnClick="btn_Back_To_Street_List_Click" />
    </div>
</asp:Content>
